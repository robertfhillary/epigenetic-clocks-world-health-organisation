...
d1 =readRDS("U:/Datastore/IGMM/marioni-lab/Rob/Epigenetic Clocks WHO/Incidence/PheWAS_phenotypes_GS_10k.rds")
pain =read.csv("U:/Datastore/IGMM/marioni-lab/Generation_Scotland_data/PCQ/chronic_painv5.csv")
