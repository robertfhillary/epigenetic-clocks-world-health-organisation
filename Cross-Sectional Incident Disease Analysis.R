setwd("U://Datastore//IGMM//marioni-lab//Rob//Epigenetic Clocks WHO//Incidence")

## Preparing of Phenotype Files 

DNAm_w1 <- read.csv("U:/Datastore/IGMM/marioni-lab/Generation_Scotland_data/DNAmAge/STRADL_w1_DNAmAge_combined_agemonths.csv")
DNAm_w3 <- read.csv("U:/Datastore/IGMM/marioni-lab/Generation_Scotland_data/DNAmAge/STRADL_w3_DNAmAge_combined.csv")

demog_w1 <- read.csv("U:/Datastore/IGMM/marioni-lab/Generation_Scotland_data/DNAmAge/stradl-samples-5101.csv")
demog_w3 <-  read.csv("U:/Datastore/IGMM/marioni-lab/Generation_Scotland_data/DNAmAge/samplesheet.final.csv")
...
pck_yrs <- read.csv("U:/Datastore/IGMM/marioni-lab/Generation_Scotland_data/updated_smoking_Jan2019/pack_years.csv")
body <- read.csv("U:/Datastore/IGMM/marioni-lab/Generation_Scotland_data/clinical/body.csv")
simd <- read.csv("U:/Datastore/IGMM/marioni-lab/Generation_Scotland_data/Clinical/SIMD.csv")
ea <- read.csv("U:/Datastore/IGMM/marioni-lab/Generation_Scotland_data/PCQ/education.csv")
alc <- read.csv("U:/Datastore/IGMM/marioni-lab/Generation_Scotland_data/PCQ/alcohol.csv")
